...
from pages import index, predictions, explain
...
navbar = dbc.NavbarSimple(
    brand='Home Price Predictor',
    brand_href='/',
    children=[
        dbc.NavItem(dcc.Link('Predictions', href='/predictions', className='nav-link')),
        dbc.NavItem(dcc.Link('Explain', href='/explain', className='nav-link')),
    ],
    sticky='top',
    color='primary',
    dark=True
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Richard Tregaro', className='mr-2'),
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:rcloud18@icloud.com'),
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/Rtrey29/price_predict_project'),
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/richard-tregaro-84677418a/'),
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/RichTregaro'),
                ],
                className='lead'
            )
        )
